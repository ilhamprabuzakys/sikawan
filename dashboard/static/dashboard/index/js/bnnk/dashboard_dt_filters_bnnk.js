function getURLFilter(kabupaten, kecamatan, status, tahun) {
    let url = `/dashboard/masters/api/v1/desa/?format=datatables&kabupaten=${id_kabupaten}`;
...
function handleApplyFilter() {
    ...
    const url = getURLFilter(filter_kabupaten, filter_kecamatan, filter_status, filter_tahun);
